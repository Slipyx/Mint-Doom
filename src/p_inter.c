...
//
boolean P_GiveAmmo(player_t *player, ammotype_t ammo, int32_t num)
{
    int32_t    oldammo;
...
//
boolean P_GiveBody(player_t *player, int32_t num)
{
...
//
boolean P_GiveArmor(player_t *player, int32_t armortype)
{
    int32_t    hits;
...
// P_GivePower
//
boolean P_GivePower(player_t *player, int32_t /*powertype_t*/ power)
{
...
void P_TouchSpecialThing(mobj_t *special, mobj_t *toucher)
{
    ...
    switch (special->sprite)
    {
        ...
        case SPR_MEDI:
            ...
            // JoshK: If health was less than 25 before pickup, it will be less
            //  than 50 after pickup, so show GOTMEDINEED message
            if (player->health < 50)
            {
